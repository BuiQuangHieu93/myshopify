        ...
        >
          {imageHover ? (
            <>
              ...
              />
              {status !== "" && (
                <div className="absolute top-[40px] right-[0px] transform -translate-x-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-green-500">
                  <div className="h-12 w-12 text-white flex-center">
                    {status}
                  </div>
                </div>
              )}
              {sale && (
                <div className="absolute top-[40px] right-[0px] transform -translate-x-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-orange-500">
                  <div className="h-12 w-12 text-white flex-center">
                    -{CalulatedSale()}%
                  </div>
                </div>
